...
public class SysFileController extends BaseController {
    ...
    public SysOssUploadVo upload(UploadedFile file) {
        FileInfo info = fileStorageService.of(
                file.getContent(), file.getName(), file.getContentType(), file.getContentSize()).upload();
