...
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (500, 108, '操作日志', 1, 'operlog', 'monitor/operlog/index', '', '1', '0', 'C', '0', '0', 'monitor:operlog:list', 'arcticons:one-hand-operation', '操作日志菜单', 103, 1, '2025-05-27 13:19:44', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (501, 108, '登录日志', 2, 'logininfor', 'monitor/logininfor/index', '', '1', '0', 'C', '0', '0', 'monitor:logininfor:list', 'streamline:interface-login-dial-pad-finger-password-dial-pad-dot-finger', '登录日志菜单', 103, 1, '2025-05-27 13:19:44', NULL, NULL);
