...
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3, 0, '系统工具', 4, 'tool', NULL, '', '1', '0', 'M', '0', '0', '', 'ant-design:tool-outlined', '系统工具目录', 103, 1, '2025-05-27 13:19:44', NULL, NULL);
...
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (115, 3, '代码生成', 2, 'gen', 'tool/gen-code/index', '', '1', '0', 'C', '0', '0', 'tool:gen:list', 'tabler:code', '代码生成菜单', 103, 1, '2025-05-27 13:19:44', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (116, 3, '代码模板', 3, 'genTemplate', 'tool/gen-template/index', '', '1', '0', 'C', '0', '0', 'tool:gen:list', 'tabler:template', '代码生成菜单', 103, 1, '2025-05-27 13:19:44', NULL, NULL);
...
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (127, 1, '在线插件', 12, 'plugin', 'system/plugin/index', '', '1', '0', 'C', '0', '0', 'system:plugin:list', 'material-symbols:extension-outline', '在线插件管理菜单', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
...
-- 在线插件管理按钮
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1080, 127, '在线插件查询', 1, '#', '', '', '1', '0', 'F', '0', '0', 'system:plugin:query', '#', '', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1081, 127, '在线插件新增', 2, '#', '', '', '1', '0', 'F', '0', '0', 'system:plugin:add', '#', '', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1082, 127, '在线插件修改', 3, '#', '', '', '1', '0', 'F', '0', '0', 'system:plugin:update', '#', '', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1083, 127, '在线插件删除', 4, '#', '', '', '1', '0', 'F', '0', '0', 'system:plugin:delete', '#', '', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1084, 127, '在线插件扫描', 5, '#', '', '', '1', '0', 'F', '0', '0', 'system:plugin:scan', '#', '', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
REPLACE INTO `sys_menu` (`id`, `parent_id`, `menu_name`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1085, 127, '在线插件上传', 6, '#', '', '', '1', '0', 'F', '0', '0', 'system:plugin:upload', '#', '', 103, 1, '2026-06-13 00:00:00', NULL, NULL);
